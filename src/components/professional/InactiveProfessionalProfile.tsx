...
import { UserCog, ShoppingBag, Mail } from "lucide-react";

const InactiveProfessionalProfile = () => {
        ...
        <Card className="border-2 border-dashed">
          <CardHeader className="text-center space-y-2">
            ...
            <p className="text-muted-foreground text-lg">
              Your professional profile has been created and is pending system approval.
            </p>
          </CardHeader>
...
export default InactiveProfessionalProfile; 